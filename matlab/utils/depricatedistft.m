%% NOT OUR CODE
%  Found here: http://www.ee.columbia.edu/~dpwe/e4810/matlab/s24/istft.m
%  Author:

function x = depricatedistft(d, ftsize, w, h)
% X = _istft(D, F, W, H)                   Inverse short-time Fourier transform.
