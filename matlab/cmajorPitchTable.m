% original pitchTable taken from https://pages.mtu.edu/~suits/notefreqs.html
% frequencies are given in Hz
% it is, however, a single row vector (modified from the original to be so)
%           C        D        E        F        G        A        B     
cmajorPitches = [ 16.35,   18.35,   20.60,   21.83,   24.50,   27.50,   30.87, ...
            32.70,   36.71,   41.20,   43.65,   49.00,   55.00,   61.74, ...
            65.41,   73.42,   82.41,   87.31,   98.00,   110.00,  123.47, ...
            130.81,  146.83,  164.81,  174.61,  196.00,  220.00,  246.94, ...
            261.63,  293.66,  329.63,  249.23,  392.00,  440.00,  493.88, ...
